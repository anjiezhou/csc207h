...
- Method lookup is a two-step process. 
    - ***Step 1:*** At compile time, Java selects a method signature using the declared types of the receiver (the object before the dot) and arguments. i.e., it selects the overloading method, if any. 
